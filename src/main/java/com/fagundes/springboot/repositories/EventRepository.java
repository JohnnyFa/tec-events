...
import com.fagundes.springboot.domain.event.EventAddressProjection;
...
public interface EventRepository extends JpaRepository<Event, UUID> {
    ...
    @Query("SELECT e.id AS id, e.title AS title, e.description AS description, " +
            "e.date AS date, e.imgUrl AS imgUrl, e.eventUrl AS eventUrl, " +
            "e.remote AS remote, a.city AS city, a.uf AS uf " +
